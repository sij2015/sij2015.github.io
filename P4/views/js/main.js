...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        // I am reusing already given code from the "function sizeSwitcher" to assign "straight" values to the variable "newwidth"
        // instead of "function changePizzaSizes" calculate it over and over again and going with the percentages instead of the pixels.
        var newwidth;
        switch (size) {
            case "1":
                newwidth = 25;
        ...
        // There is no need to recalculate it over and over again and because of that I pulled it out of the "for" loop.
        randomPizzaContainerLength = document.getElementsByClassName("randomPizzaContainer").length;
...
var cols = 8;
var s = 256;
// 200 pizzas is too much for one visible screen (page fold)
// Because of that I am using a fixed number of pizzas based on a visible screen size.
// https://developer.mozilla.org/en-US/docs/Web/API/Window/innerHeight
var numberOfPizzas = Math.floor((window.innerHeight * cols) / s);
